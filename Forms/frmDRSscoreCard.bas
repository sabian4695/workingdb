...
DoCmd.applyFilter , "[Assignee] = " & iUser & " AND [Completed_Date] Between #10/1/" & CStr(Me.fltYear) & "# And #12/31/" & CStr(Me.fltYear) & "# AND Adjusted = True"
...
DoCmd.applyFilter , "[Assignee] = " & iUser & " AND [Completed_Date] Between #10/1/" & CStr(Me.fltYear) & "# And #12/31/" & CStr(Me.fltYear) & "# AND Late = True"
